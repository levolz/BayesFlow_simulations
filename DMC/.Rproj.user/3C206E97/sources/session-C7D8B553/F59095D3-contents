...
# with Upper Censoring (UC)
#    External parameters types: tf, gf, mu, sigma, tau, muS, sigmaS, tauS, UC 
#    Internal parameters types: tf, gf, mu, sigma, tau, UC 
...
{
  rexgss.cens(n,mu=p.df$mu,sigma=p.df$sigma,tau=p.df$tau,tf=p.df$tf[1],
